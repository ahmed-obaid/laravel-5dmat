...
<body class="index-page sidebar-collapse" style='background-color:' >
 ...
 @include('layouts.nav')
  ...
  @include('layouts.footer')
    ...
    <script src="{{asset('frontend/js/paper-kit.js?v=2.2.')}}" type="text/javascript"></script>
    <!--  Google Maps Plugin    -->
